...
There is a clear **positive correlation**: countries generating more plastic waste per capita tend to mismanage  more per person, with dispersion increasing at higher values.
...
Continents are somewhat separate; Europe/North America tend to have **higher waste per capita** but **lower mismanaged share** than Africa/Asia, which show higher mismanaged values at comparable waste levels. Still, there's overlap showing continent isn't the only driver.
